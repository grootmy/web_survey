...
import { updatePost, fetchCategories } from "@/lib/api";
...
export default function EditPostForm({ post }: EditPostFormProps) {
  ...
  const [boardId, setBoardId] = useState<Seg["value"]>(
    post.category?.slug || "qna"
  );
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setErr(e.message ?? "게시글 수정에 실패했습니다.");
      setSubmitting(false);
    }
  }
