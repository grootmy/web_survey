...
export const boards: Board[] = [
  { id: "qna",               slug: "qna",                title: "Q&A" },
  { id: "product-reviews",   slug: "product-reviews",    title: "제품리뷰" },
  { id: "manage-reviews",    slug: "manage-reviews",     title: "관리후기" },
  { id: "procedure-reviews", slug: "procedure-reviews",  title: "시술후기" },
  { id: "research-news",     slug: "research-news",      title: "연구 및 뉴스" },
  { id: "useful-info",       slug: "useful-info",        title: "유용 정보" },
  { id: "clinics",           slug: "clinics",            title: "지역 병원/클리닉" },
];

// “치료/약 정보”에서 제공할 태그 프리셋(왼쪽 메뉴용)
export const treatmentTags: never[] = [];

export const posts: Post[] = Array.from({ length: 24 }).map((_, i) => ({
  id: String(i + 1),
  // 새 카테고리 id 중 하나로 샘플 분배
  boardId: ["qna","product-reviews","manage-reviews","procedure-reviews","research-news","useful-info","clinics"][i % 7],
